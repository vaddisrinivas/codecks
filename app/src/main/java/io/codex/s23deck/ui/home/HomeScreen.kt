...
import io.codex.s23deck.ui.connection.ConnectionHealthKind
import io.codex.s23deck.ui.connection.isReady
import io.codex.s23deck.ui.connection.simpleConnectionHealth
import io.codex.s23deck.ui.icons.deckImageVector
        ...
        Column(
            ...
            Row(
                ...
                IconButton(onClick = onOpenDrawer) {
                    Icon(Icons.Outlined.Menu, contentDescription = "Open navigation", tint = deckTextColor)
                }
...
private fun isDeckActionEnabled(action: DeckAction, connectionReady: Boolean): Boolean =
    action.kind != ActionKind.Ssh || connectionReady || action.id in setOf("add_button", "blank")
