...
| Trackpad | `docs/images/screenshots/codecks-trackpad.png` | README gallery, store listing, demo scene 2 |
| Automations | `docs/images/screenshots/codecks-automations.png` | README gallery, demo scene 3 |
...
- One 15-25 second silent README GIF from the Framecraft config in this folder.
