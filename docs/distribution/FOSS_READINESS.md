...
Status: ready for maintainer review before publishing.
...
- Release: signed APK and checksum workflow exists.
...
- Confirm latest release APK is attached to a GitHub release with checksum.
