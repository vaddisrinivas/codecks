...
Current public beta is `v0.1.7`. Keep Codecks local-only: do not deploy a backend or public database. Keep account, billing, hosted sync, advanced surfaces, and alternate APKs disabled.
...
- [x] `v0.1.7` release workflow publishes a single signed APK with checksum.
